...
async function iniciarApp() {
    ...
    // Actualizar los textos de la navbar y el footer con el idioma inicial
    ...
    // Navegar a la sección que indica el hash actual (o tienda por defecto)
    navegar();
}
...
function aplicarTema(tema) {
    ...
    // Quitar ambas clases y ponemos la correcta
